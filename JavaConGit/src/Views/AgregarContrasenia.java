 ...
 * @author ja-za
 */
public class AgregarContrasenia extends javax.swing.JDialog {

    /**
     * Creates new form AgregarContraseña
     */
    public AgregarContrasenia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar nueva contraseña");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarContrasenia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarContrasenia dialog = new AgregarContrasenia(new javax.swing.JFrame(), true);
